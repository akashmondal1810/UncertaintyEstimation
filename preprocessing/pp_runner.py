...
class runPreprocess():
    ...
    def __init__(self, data_input_path):
        ...
        _preprocessing_file_PATH = 'preprocessing/preprocessing.json'
    ...
    def _read_csv_file(self):
    	...
    	chunksize = self.ppc_parameters["chunk_size"]
    	if len(col_to_read):
    		for chunk in pd.read_csv(self._input_path, usecols=col_to_read,  chunksize=chunksize):
    			
    			return chunk
    	else:
    		for chunk in pd.read_csv(self._input_path, chunksize=chunksize):
    			return chunk
